...
# Find R0 of COVID-19 using data from January 21st to January 31st.
...
# Simulate the spread of COVID in the world, from 282 cases on January 21st.
simulate(population=8000000000, initial_cases=282, simulation_days=344, covid_r0=covid_r0, immune_days=200, save_file=True, filename="data/no_intervention.csv")
...
# Simulate the spread of COVID in the world from 282 cases on January 21st, if the world somehow achieved > 70% vaccination rate and mask wearing during that timeframe.
simulate(population=8000000000, initial_cases=282, simulation_days=344, covid_r0=covid_re_vaccine, immune_days=200, save_file=True, filename="data/vaccine-2021.csv")