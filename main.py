...
covid_re_mask = find_r0(initial_cases=10931, final_cases=19138, population=6681000, days=31, iterations=10000, mode="cumulative")
print(f"COVID Re (with Victorian Stage 4 - 2020 Restrictions): {covid_re_mask}")

# Simualte the spread of COVID in the world from 282 cases on March 1st, if the world followed Victorian restrictions during that timeframe.
